...
export const Home = () => {
  ...
  const handleFeatureClick = async (featureName: string, navigationPath: string) => {
    console.log(`🎯 Feature clicked: ${featureName}`);
    
    // Show interstitial ad on navigation
    await showInterstitialOnAction(`navigate_to_${featureName}`);
  ...
  const features = [
    {
      ...
      action: () => handleFeatureClick('seo_generator', '/seo'),
    ...
    },
    {
      ...
      action: () => handleFeatureClick('thumbnail_creator', '/thumbnail'),
    ...
    },
    {
      ...
      action: () => handleFeatureClick('content_history', '/history'),
